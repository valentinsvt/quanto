...
;(function($){
	$.contextMenu = {
		...
		createMenu: function(menu,cmenu) {
			...
			var $t = $('<table class="tablaSvt" cellspacing=0 cellpadding=0></table>').click(function(){cmenu.hide(); return false;}); // We wrap a table around it so width can be flexible
			var $tr = $('<tr></tr>');
			var $td = $('<td></td>');
