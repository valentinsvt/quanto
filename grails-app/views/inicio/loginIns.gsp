...
<html>
  ...
  <center>
    <div class="contenedor">
      ...
      <div class="info">
        <div class="texto">
          <ul>
            <br>
            <li>Aplicación de encuestas para Instituciones</li>
            <br>
            <li>Identifíquese para registrar la encuesta.</li>
          </ul>
        </div>
        <div class="textoDer">
          <img src="${resource(dir:'images',file:'qinst.jpg')}" >
        </div>
      </div>
      <div class="login">
        <g:form action="loginIns" method="post">
          <fieldset style="width: 350px; height: 145px; margin-top: 4px; border-color: black;" >
            ...
            <div class="fila azul der bs" style=" width: 360px;margin-left: 0px;">
              <input type="radio" name="tipo" value="ext">Informante Externo
              <input type="radio" name="tipo" value="int" checked>Informante Interno
            </div>
            <div class="fila">
    ...
    <div class="pie"> Desarrollado por: TEDEIN SA &nbsp;&nbsp;&nbsp;&nbsp;http://www.evaluacion-educacion.com </div>
