    ...
    <div class="contenedor">
      ...
      <div class="info">
        <div class="texto">
          <ul>
            <br>
            <li>Aplicación de encuestas para el personal Administrativo</li>
            <br>
        ...
        <g:form action="loginAdm" method="post">
          <fieldset style="width: 360px; height: 145px; margin-top: 4px; border-color: black;" >
            ...
            <div class="fila azul der"  style="margin-top: 40px;">
              <input type="radio" name="tipo" value="ext">Soy informante
              <input type="radio" name="tipo" value="auto" checked style="margin-left: 15px;">Autoevaluación
            </div>
            <div class="fila">
