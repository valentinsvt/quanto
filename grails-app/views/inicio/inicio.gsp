...
<div class="contenido ui-widget-content ui-corner-all " style="margin: auto;margin-top: 30px; position: relative">
    <div id="1" class="botones " style="position: absolute; left: 100px; top: 40px; width: 245px; height: 167px;z-index: 1">
        <g:link action="login"  ><div   ><img  class="img_1" src="${resource(dir:'images',file:'qencu.jpg')}" style="border: white;" /></div></g:link>
    </div>
    <div id="2" class="botones " style="position: absolute; left: 430px; top: 40px; width: 246px; height: 167px;z-index: 2">
        <g:link action="loginAdm" ><div ><img class="img_2" src="${resource(dir:'images',file:'qadmn.jpg')}" style="border: white"/></div></g:link>
    </div>
    <div id="3" class="botones " style="position: absolute; left: 100px; top: 240px; width: 245px; height: 167px;z-index: 1">
        <g:link action="loginPares"  ><div>@c<img  class="img_3" src="${resource(dir:'images',file:'qencu.jpg')}" style="border: white;" /></div></g:link>
    </div>
    <div id="4" class="botones " style="position: absolute; left: 430px; top: 240px; width: 246px; height: 167px;z-index: 2">
        <g:link action="loginDirec" ><div >@c<img class="img_4" src="${resource(dir:'images',file:'qadmn.jpg')}" style="border: white"/></div></g:link>
    </div>
    %{--
    ...
    <div class=" span-8  " style="position: absolute;left: 30px; bottom:  10px; text-align: left;  padding: 10px;width: 90%;padding-top: 0px;" >
        <div style="color: #375E89; text-align:left;  font-size:20px; margin: 10px;border-bottom: 1px solid black;border-bottom-color:#124080;margin-left: 0px;padding-bottom: 3px;">Quanto Web</div>
        Seleccione el módulo sobre el cual desea realizar su encuesta:<br/>
        <b>Quanto Docentes</b>: Evaluación a Profesores<br/>
        <b>Quanto Administrativos</b>: Evaluación del personal administrativo<br>
        <b>Quanto Pares</b>: Evaluación a Profesores<br/>
        <b>Quanto Directivos</b>: Evaluación del personal administrativo<br>
